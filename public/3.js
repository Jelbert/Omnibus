...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getReport: function getReport(label) {
      var _this8 = this;

      setTimeout(function () {
        return _this8.isReportOpen = false;
      }, 400);
      this.selectedForm = label;
      setTimeout(function () {
        return _this8.formData["p_head_cono"] = _this8.selected.code;
      }, 200); // console.log(setTimeout(() => this.formData["p_head_cono"] = this.selected.code, 500))
    }
  }
});
      ...
      _c(
        ...
        [
          _c(
            ...
            {
              staticClass: "card",
              attrs: { animation: "slide", open: _vm.isReportOpen },
              on: {
                "update:open": function($event) {
                  _vm.isReportOpen = $event
                }
              },
              scopedSlots: _vm._u([
                {
                  ...
                  [
                    _c("b-loading", {
                      attrs: {
                        ...
                        active: _vm.isReportLoading
                      },
                      on: {
                        "update:active": function($event) {
                          _vm.isReportLoading = $event
                        }
                      }
                    }),
                    _vm._v(" "),
                        ...
                        _c(
                          ...
                          [
                            _c(
                              ...
                              _vm._l(_vm.company, function(option) {
                                return _c(
                                  "option",
                                  {
                                    key: option.id,
                                    attrs: { "data-url": option.code },
                                    domProps: {
                                      value: option.id,
                        ...
                        _c(
                          ...
                          [
                                  ...
                                  return _c("li", [
                                    _c("div", [
                                      _c(
                                        ...
                                        {
                                          staticClass:
                                            "router-link-active has-icon"
                                        },
                                        [
                                          _c(
                                            "span",
                                            {
                                              staticClass: "menu-item-label ",
                                              on: {
                                                click: function($event) {
                                                  return _vm.getReport(label)
                                                }
                                              }
                                            },
                            ...
                            _c(
                              ...
                              [
                                _vm._v(" "),
                                _vm._l(_vm.prod, function(label) {
                                  return _c("li", [
                                    _c("div", [
                                      _c(
                                        "a",
