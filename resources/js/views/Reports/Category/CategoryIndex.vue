<template>
  <div>
    <title-bar :title-stack="['Admin', 'Reports', 'Manage Category']" />
    <hero-bar>
      Manage Category

        <router-link tag="button"  to="/reports/category/new" class="button" slot="right">New Category</router-link>
      ...
      >
        ...
        >
          <template slot-scope="props">
            <b-table-column label="Category" field="title" sortable>{{
              props.row.name
              }}</b-table-column>
    ...
    export default {
      ...
      methods: {
        ...
        trashConfirm() {
          ...
          if (this.trashObject) {
            method = "delete";
            url = `/reports/category/${this.trashObject.id}/destroy`;
